...
@Service
public class TwitterElasticQueryClient implements ElasticQueryClient<IndexModel> {
  ...
  private List<IndexModel> search(Query query, String logMessage, Object... logParams) {
